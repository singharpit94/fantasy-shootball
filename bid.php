...
<head>
	...
	$(function() {
		...
		<style>
body {     
	background: url(Images/surya3.jpg) no-repeat center center fixed #000; 
...
<div class="ui-widget">
	...
	<div>Choose player from Category-
	...
	<select id="combobox" class="dropdown" name="pid1" style="display: none;">';
		 <?php
	   if(isset($_GET['value']))
	   {
	    $value=$_GET['value'];
